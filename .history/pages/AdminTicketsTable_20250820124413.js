          ...
          {tickets.map((ticket) => (
            <tr key={ticket.ticketID}>
              ...
              <td>
                <select
                  value={ticket.status}
                  onChange={(e) => onEditStatus(ticket.ticketID, e.target.value)}
                  style={{
                    color:
                      ticket.status === "Open"
                        ? "#007bff"
                ...
                >
                  <option value="Open" style={{ color: "#007bff" }}>Open</option>
                  <option value="Pending" style={{ color: "#ffc107" }}>Pending</option>
                  <option value="Closed" style={{ color: "#28a745" }}>Closed</option>
                </select>
              </td>
              <td>
                {ticket.updatedAt
