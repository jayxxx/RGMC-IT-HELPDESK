            ...
            <tr key={ticket.ticketID}>
              ...
              <td>
                {statusEdit[ticket.ticketID] ? (
                  <>
                    <select
                      value={statusValue[ticket.ticketID] ?? ticket.status ?? "Open"}
                      onChange={e =>
                        setStatusValue({ ...statusValue, [ticket.ticketID]: e.target.value })
                      }
                    >
                    ...
                    <button
                      onClick={() => onSaveStatus(ticket.ticketID, statusValue[ticket.ticketID] ?? ticket.status ?? "Open")}
                    >
                      Save
                    </button>
                    <button
                  ...
                  <>
                    {ticket.status}{' '}
                    <button onClick={() => onEditStatus(ticket.ticketID)}>Edit</button>
                  </>
                )}
              </td>
              <td>
