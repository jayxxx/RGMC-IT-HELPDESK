...
export default function AdminTicketsTable({
  ...
  // Helper to show message or placeholder only if truly missing
  const renderMessage = (ticket) => {
    // Accept both 'message' and 'messages' fields, fallback to empty string
    const msg =
    ...
    return msg && msg.trim()
      ? msg
      : <span style={{ color: '#888' }}>No message entered</span>;
  };
